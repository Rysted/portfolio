...
export const Sun = ({ hover, theme }: { hover: boolean; theme: boolean }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const Moon = ({ hover, theme }: { hover: boolean; theme: boolean }) => {
  return (
    <svg
      width="20"
      height="20"
...
export const BackToTopIcon = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="w-10 h-10 stroke-dark_text transition-all duration-200 ease-in-out"
    >
      <path d="M6 11L12 5L18 11"></path>
      <path d="M6 19L12 13L18 19"></path>
    </svg>
  );
};
...
export const WavePrimary = () => {
  return (
    <svg
      ...
      id="wave-primary"
      className="fill-light_background dark:fill-dark_background transition-all duration-200 ease-in-out"
    >
