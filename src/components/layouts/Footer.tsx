...
const Footer = () => {
  return (
    <footer className="md:mt-0 lg:mr-60 px-5 pt-10 pb-5 select-none font-poppins bg-light_highlight dark:bg-dark_highlight text-light_text dark:text-dark_text">
